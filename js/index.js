...
function setTime() {
    document.getElementById("date-element").innerHTML = "INDIA, IN - " + new Date().toLocaleDateString("en-US", { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' }) + " - FOUR PAGES on this Traveller";
}
